   ...
   <div class="modal-dialog">
    <div class="modal-content">
     <div class="modal-header">
      <h4 class="modal-title">Thêm Loại Nhân Viên</h4>
    ...
    <div class="modal-body">
     ...
     <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="form-group row">
        <label class="control-label col-md-4" >Loại Nhân Viên : </label>
        <div class="col-md-8">
         <input type="text" name="tenloai" id="tenloai" class="form-control" placeholder="Nhập Loại Nhân Viên" required="" />
       </div>
     </div>
     <br />
...
<script type="text/javascript">
  $(document).ready(function(){
   ...
   $('#data_table').DataTable({
    ...
    serverSide: true,
    ajax:{
     url: "admin/loainhanvien/danh-sach",
   },
   columns:[
   {
    data: 'id',
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click', '.edit', function(){
      ...
      $('#form_result').html('');
      $.ajax({
       url:"admin/loainhanvien/edit/"+id,
       dataType:"json",
    ...
    $('#ok_button').click(function(){
      $.ajax({
       url:"admin/loainhanvien/destroy/"+id,
       beforeSend:function(){
