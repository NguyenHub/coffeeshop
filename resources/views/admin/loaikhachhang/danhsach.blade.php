   ...
   <div class="modal-dialog">
    ...
    <div class="modal-body">
     ...
     <div class="form-group row">
      ...
      <div class="col-md-8">
       <input type="text" name="tenloai" id="tenloai" class="form-control" placeholder="Nhập Loại Khách Hàng" required="" />
     </div>
   </div>
 <br />
...
<script type="text/javascript">
  $(document).ready(function(){
   ...
   $('#data_table').DataTable({
    ...
    serverSide: true,
    ajax:{
     url: "admin/loaikhachhang/danh-sach",
   },
   columns:[
   {
    data: 'id',
...
<script>
  $(document).ready(function(){
    ...
    $('#sample_form').on('submit', function(event){
     ...
     {
       $.ajax({
        url:"admin/loaikhachhang/update",
        method:"POST",
        data:new FormData(this),
        contentType: false,
        cache: false,
    ...
    $(document).on('click', '.edit', function(){
      ...
      $('#form_result').html('');
      $.ajax({
       url:"admin/loaikhachhang/edit/"+id,
       dataType:"json",
    ...
    $('#ok_button').click(function(){
      $.ajax({
       url:"admin/loaikhachhang/destroy/"+id,
       beforeSend:function(){
